 ...
 *
 * Input
 * First line of input contains of an integer 'T' denoting number of test cases. First line of each testcase contains N .
 ...
 * We can make maximum 4 segments each of length 1. In secon test case,
