...
import com.flink.examples.producer.FileSourceFunction;
...
public class TumblingWindow_AverageProfit
{
    public static void main(String[] args) throws Exception
    {
        ...
        DataStreamSource<String> data =  env.addSource(new FileSourceFunction());
        ...
        reduced.map(t -> String.format("Reduced %s",t.toString())).print();
        // execute program
